    ...
    <div className="flex flex-1 flex-col items-center px-4 py-10 sm:py-16">
      <main className="w-full max-w-xl">
        ...
        <header className="mb-6 flex items-center justify-center gap-5">
          ...
          />
          <Image
            src="/images/logo-osis-circle.png"
            alt="Logo OSIS Smanichi"
            width={1128}
            height={1128}
            className="h-16 w-auto drop-shadow-sm sm:h-20"
            priority
        ...
        <div className="nb-card mb-7 overflow-hidden p-0">
          <Image
            ...
            alt="Poster MPLS Smanichi 2026 — Ozone"
            width={837}
            height={1184}
        ...
        <section className="mb-7 text-center">
          ...
          <div className="mx-auto mt-4 max-w-md rounded-2xl border-2 border-[var(--ink)] bg-[var(--gold)] px-4 py-3 text-[var(--ink)] nb-shadow-sm">
            <p className="font-display text-sm leading-snug font-bold sm:text-base">
              &ldquo;MPLS ramah, hari baru aman dan nyaman di sekolah&rdquo;
            </p>
          </div>
        </section>
        ...
        <section className="nb-card mb-6 p-5 sm:p-6">
          <h2 className="mb-3 font-display text-lg font-bold uppercase text-[var(--ink)]">
            Buku Panduan MPLS 2026
          </h2>
          <p className="text-sm leading-relaxed text-[var(--ink)]/85 sm:text-base">
            Tautan ini merupakan Buku Panduan kegiatan MPLS SMA Negeri 1 Bangli
            tahun 2026! Telah termuat segala hal yang menjadi acuan seluruh calon
            murid SMA Negeri 1 Bangli selama berkegiatan di Masa Pengenalan
            Lingkungan Sekolah Tahun Ajaran 2026-2027.
          </p>
        ...
        <footer className="mt-10 text-center">
          <p className="font-mono text-[0.7rem] font-bold uppercase tracking-widest text-[var(--ink)]/70">
            MPLS SMA Negeri 1 Bangli · 2026
          </p>
          <p className="mt-1 text-[0.7rem] text-[var(--ink)]/55">
            OSIS &amp; MPK Ozone Smanichi
          </p>
        </footer>
      </main>
    </div>
